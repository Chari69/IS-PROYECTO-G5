...
//Constructor
   public panel_menu_UI() {
    ...
    configurarTarjeta(Panel_Desayuno, "Desayuno", "Descripción del desayuno", "Horario: 7:00 - 10:00", "resources/arepa.jpg");
    gbc.gridx = 1;
    ...
    configurarTarjeta(Panel_Almuerzo, "Almuerzo", "Descripción del almuerzo", "Horario: 12:00 - 15:00", "resources/images.jpg");
    gbc.gridx = 2;
    gbc.weightx = 0.4; // Más espacio para los paneles principales
