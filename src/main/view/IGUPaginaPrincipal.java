...
public class IGUPaginaPrincipal{
    ...
    private static void Buttons(JFrame frame){
        ...
        button_inicio_sesion.addActionListener(e -> {button_inicio_sesion.setForeground(Color.gray);});
        ...
        button_registro.addActionListener(e -> {button_registro.setForeground(Color.gray);});
