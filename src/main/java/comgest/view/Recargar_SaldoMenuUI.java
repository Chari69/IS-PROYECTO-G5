...
public class Recargar_SaldoMenuUI extends JPanel {
  ...
  void configurar_der() {
    ...
    // --- NUEVO: CAMPO CÉDULA ---
    JLabel label_cedula = new JLabel("CÉDULA DEL BENEFICIARIO"); // Para el Saldo Pana
    ...
    public void PanitaDinamico(JLabel lbl){
        panita.addMouseListener(new java.awt.event.MouseAdapter() {
        @Override
