...
import comgest.controller.RegistrarTipoUsuarioController;
...
public class RegistrarTipoUsuario extends JPanel {
    ...
    public void asignarControlador(RegistrarTipoUsuarioController controller) {
        submmit.addActionListener(controller);
        submmit.setActionCommand(RegistrarTipoUsuarioController.ACTION_SUBMIT);
    }
